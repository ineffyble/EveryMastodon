...
const res = await fetch(`https://instances.social/api/1.0/instances/list?count=10000&include_down=false&include_closed=true&min_users=50&sort_by=active_users&sort_order=desc`, {
    headers: {
